...
export function AboutUs() {
  return (
    <div className="min-h-screen bg-neutral-background">
      ...
      {/* Main Content */}
      <section className="pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 md:pb-20 lg:pb-24 bg-neutral-background">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <SmoothScrollReveal animation="fade">
              <div className="mb-12 sm:mb-16">
                ...
                <p className="text-base sm:text-body-lg font-body text-neutral-text-secondary leading-relaxed mb-6 sm:mb-8">
                  Welcome to Agnicio, where data analytics meets the power of insight and transformation.
                </p>

                <p className="text-sm sm:text-body font-body text-neutral-text-secondary leading-relaxed mb-6 sm:mb-8">
                ...
                <div className="bg-primary/5 border border-primary/20 rounded-xl sm:rounded-2xl p-6 sm:p-8 text-center">
                  <p className="text-base sm:text-body-lg font-body text-neutral-text-secondary mb-4 sm:mb-6">
                    Ready to experience your "peripeteia" with data, and explore the possibilities of generative AI?
                  </p>
                  <a
                    href="mailto:info@agnicio.com"
                    className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-primary text-white font-body font-semibold rounded-lg hover:bg-primary-hover transition-all duration-300 shadow-lg hover:shadow-xl min-h-[44px] w-full sm:w-auto text-sm sm:text-base"
                  >
            ...
            <SmoothScrollReveal animation="fade">
              <div className="mb-12 sm:mb-16">
                <h2 className="text-xl sm:text-2xl md:text-h2 font-heading font-bold text-neutral-text-primary mb-8 sm:mb-12 text-center">
            ...
            <SmoothScrollReveal animation="fade">
              <div className="text-center mb-12 sm:mb-16">
                <div className="bg-gradient-to-r from-primary/10 to-primary-hover/10 border border-primary/30 rounded-xl sm:rounded-2xl p-6 sm:p-8">
                  <h2 className="text-xl sm:text-2xl md:text-h3 font-heading font-bold text-neutral-text-primary mb-3 sm:mb-4">
                    Our Mission
                  </h2>
                  <p className="text-base sm:text-body-lg font-body text-neutral-text-secondary leading-relaxed">
            ...
            <SmoothScrollReveal animation="fade">
              <div className="text-center">
                <h2 className="text-xl sm:text-2xl md:text-h3 font-heading font-bold text-neutral-text-primary mb-6 sm:mb-8">
                  Visit Our Office
                </h2>
                <div className="bg-neutral-surface rounded-xl sm:rounded-2xl overflow-hidden shadow-lg border border-neutral-border">
                  <iframe
                ...
                <p className="text-sm sm:text-body font-body text-neutral-text-secondary mt-3 sm:mt-4">
