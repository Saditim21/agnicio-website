...
import dataStrategyVideo from '../assets/services-page/data-strategy.mp4';
  ...
  return (
    <div className="min-h-screen bg-neutral-background">
      ...
      <section ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          <source src={dataStrategyVideo} type="video/mp4" />
        </video>
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="mb-8">
              <h1 className="text-h1 lg:text-6xl font-heading font-bold leading-tight">
                {"Shape your Data Strategy".split(' ').map((word, wordIndex) => {
                  const totalCharsBefore = "Shape your Data Strategy".split(' ').slice(0, wordIndex).join('').length;
                  return (
            ...
            >
              Data Strategy is a strategic business opportunity that requires both <strong className="text-white">business expertise</strong> and <strong className="text-white">technical savviness</strong>. Data strategy can influence (and disrupt) business models to become a competitive advantage. Many companies that have jumped directly into making use of data without having a well-formulated data strategy are struggling to prove the expected business value.
            </p>

            {/* Sub-heading */}
            <h2
              className="text-h3 font-heading font-semibold text-white/95 mb-12"
              style={{
                opacity: progress,
                transform: `translateY(${(1 - progress) * 20}px)`,
          ...
          <div className="max-w-6xl mx-auto">
            <SmoothScrollReveal animation="slide-up" distance={60}>
              <h2 className="text-h2 font-heading font-bold text-neutral-text-primary mb-6 text-center">
                Benefits of a good <span className="text-primary">Data Strategy</span>
              </h2>
            </SmoothScrollReveal>

            <SmoothScrollReveal animation="fade" distance={40}>
              <div className="bg-white rounded-xl p-8 shadow-lg border-l-4 border-primary mb-12 transform hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
      ...
      {/* What Makes a Good Data Strategy Section */}
      <section className="py-24 bg-neutral-surface relative overflow-hidden">
        {/* Decorative background */}
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-20 left-10 w-96 h-96 bg-primary rounded-full blur-3xl"></div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            <SmoothScrollReveal animation="slide-up" distance={60}>
              <h2 className="text-h2 font-heading font-bold text-neutral-text-primary mb-6 text-center">
                What makes a good <span className="text-primary">data strategy?</span>
              </h2>
            </SmoothScrollReveal>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              <h2 className="text-h2 font-heading font-bold text-white mb-6">
                Ready to Shape Your Data Strategy?
              </h2>
              <p className="text-body-lg text-white/90 mb-8">
                Let's discuss how our data strategy expertise can transform your business and unlock the full potential of your data.
              </p>
              <a
                href="#contact"
